...
float Shape::getXcenOffset() const {
    return xcenOffset;
}

void Shape::setXcenOffset(float _xcenOffset) {
    xcenOffset = _xcenOffset;
}

float Shape::getYcenOffset() const {
    return ycenOffset;
}

void Shape::setYcenOffset(float _ycenOffset) {
    ycenOffset = _ycenOffset;
}
