...
public:
    ...
    float getXcenOffset() const;
    void setXcenOffset(float _xcenOffset);
    float getYcenOffset() const;
    void setYcenOffset(float _ycenOffset);
    ...
    //
    //virtual Shape *duplicate(string colour) = 0;
...
protected:
    ...
    //Shape(const Shape& rhs, string colour);
